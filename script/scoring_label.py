...
def main():
    ...
    for i in id_topics:
        labels_dic = grant_label.show_labels(id_topic=i,num_labels=100)
        pd.DataFrame(labels_dic).to_csv("{0}/result/labels/2gram/{1}/topic_{2}.csv".format(root_path,category,i))
